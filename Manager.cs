...
public class Manager : MonoBehaviour
{
    ...
    // SelectItem function removes a random item from wasteList
    ...
    // Game function is where most of the logic for they keys happen.
    private void Game()
    {
    ...
    // IsItemRecycleable returns a boolean 
    // @return true if item is on the recycling list
    private bool IsItemRecycleable()
    {
        return recycleArray.Contains(currentItem);

    }
    // WasteInvisble sets all the trash game objects invisible
